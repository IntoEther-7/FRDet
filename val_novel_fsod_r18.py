...
json_path = 'annotations/fsod_test.json'
img_path = 'images'
...
if __name__ == '__main__':
    ...
    # way_shot_test(5, 5, 2e-03, '20221208_减少roi数量')
    # way_shot_test(2, 5, 2e-03, '20221211_resnet50')
    way_shot_test(2, 5, 2e-03, '20221210_增加rpn_batch_size_per_image')
