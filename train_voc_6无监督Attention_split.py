...
if __name__ == '__main__':
    ...
    # 20221214 晚上
    way_shot_train(2, 5, 2e-03, loss_weights无监督attention, 1, '20221214_无监督attention_voc1', base_ids_voc1)
    way_shot_train(2, 5, 2e-03, loss_weights无监督attention, 1, '20221214_无监督attention_voc2', base_ids_voc2)
    way_shot_train(2, 5, 2e-03, loss_weights无监督attention, 1, '20221214_无监督attention_voc3', base_ids_voc3)
