...
loss_weights无aux = {'loss_classifier': 1, 'loss_box_reg': 1,
                            'loss_objectness': 1, 'loss_rpn_box_reg': 1,
                            'loss_attention': 1, 'loss_aux': 0}
loss_weights无cls = {'loss_classifier': 0, 'loss_box_reg': 1,
                            'loss_objectness': 1, 'loss_rpn_box_reg': 1,
                            'loss_attention': 1, 'loss_aux': 0} # 测试用
...
if __name__ == '__main__':
    ...
    # 20221214 晚上
    # way_shot_train(2, 5, 2e-03, loss_weights0, 0, '20221215_无监督_5x5_voc1', base_ids_voc1)
    # way_shot_train(2, 5, 2e-03, loss_weights0, 0, '20221215_无监督_5x5_voc2', base_ids_voc2)
    # way_shot_train(2, 5, 2e-03, loss_weights0, 0, '20221215_无监督_5x5_voc3', base_ids_voc3)
    # 20221216 晚上
    # way_shot_train(5, 5, 2e-03, loss_weights0, 1, '20221215_无监督_5x5_voc1', base_ids_voc1)
    # way_shot_train(5, 5, 2e-03, loss_weights0, 1, '20221215_无监督_5x5_voc2', base_ids_voc2)
    # way_shot_train(5, 5, 2e-03, loss_weights0, 1, '20221215_无监督_5x5_voc3', base_ids_voc3)
    # 20221217 上午
    way_shot_train(2, 5, 2e-03, loss_weights0, 0, '20221215_无监督_5x5_simple_voc1', base_ids_voc1)
