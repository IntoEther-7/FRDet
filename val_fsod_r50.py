...
if __name__ == '__main__':
    ...
    # ----------------------------------------------------------------------------------------
    weight_path = 'weights_fsod_r50/frnod27_160.pth'
    ...
    for i in range(mission):
        ...
        if not os.path.exists('datasets/fsod/annotations/prediction_json'):
            os.makedirs('datasets/fsod/annotations/prediction_json')

        with open('datasets/fsod/annotations/prediction_json/fsod_prediction_r50_mission{}.json'.format(i + 1),
                  'w') as f:
